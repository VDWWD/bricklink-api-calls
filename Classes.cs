...
namespace VdwwdBrickLink
{
    public class Classes
    {
        public class PushNotification
        {
            ...
            public Enums.EventType type
            {
                get
                {
                    ...
                    Enums.EventType et = Enum.TryParse(event_type.Replace(" ", ""), true, out et) ? et : Enums.EventType.None;
        ...
        internal class OAuthRequestParameter
        {
            public string Key { get; set; }
            public string Value { get; set; }
            public string KeyValueUrl
            {
                get
                {
                    return Uri.EscapeDataString(Key + "=" + Value);
                }
            }
            public string KeyValueHeader
            {
                get
                {
                    return $"{Key}=\"{Value}\"";
